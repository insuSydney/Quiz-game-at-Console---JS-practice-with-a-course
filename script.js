...
(Hint: Try to use the power of closures for this, but don't have to, just do this with the tools you feel more comfortable at this point).
...
(function() {
    ...
    // As methods are attached to the constructor with prototype from outside, these methods won't be attached to the instances. 
    ...
    var q1 = new Question('What is your favourite language?',
                        ['English', 'JavaScript'],
                        1);
    var q2 = new Question('What is Pearl?',
                        ['Jewellry', 'Beach', 'Pretty cat'],
                        2);
    var q3 = new Question('Which one is NOT the tennis Grand Slam?',
                        ['US Open', 'Wimbledon', 'Sydney Open', 'Roland-Garros'],
                        2);
